...
<head>
    ...
    <title>Holiday house Estere</title>
            ...
            if ($result_reviews && $result_reviews->num_rows > 0) {
                ...
                while($row_review = $result_reviews->fetch_assoc()) {
                    ...
                    <div class="swiper-slide slide">
                        ...
                        <div class="user">
                            <img src="https://t3.ftcdn.net/jpg/03/58/90/78/360_F_358907879_Vdu96gF4XVhjCZxN2kCG0THTsSQi8IhT.jpg" alt="Default profile picture">
                            <div class="user-info">
